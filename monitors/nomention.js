exports.run = (client, msg) => {
  ...
  if (msg.mentions.everyone) client.console.log(`${user} mentioned everyone in ${channel}`);
  else if (msg.mentions.users.has(client.user.id)) client.console.log(`${user} mentioned you in ${channel}`);
};
